...
const MyWorkTab: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const channel = supabase
            .channel(`my-work-assignments-${user.id}`)
            .on('postgres_changes', { event: '*', schema: 'public', table: 'assignments', filter: `assignee_id=eq.${user.id}` }, fetchMyWork)
            .subscribe();
    ...
    return (
        <>
            <div className="space-y-4 p-2">
                 <h2 className="text-xl font-bold text-text-heading">My Assigned Work</h2>
