...
const CollegeChat: React.FC<CollegeChatProps> = ({ collegeName, profile, isModerator }) => {
            ...
            .on(
                ...
                async (payload: any) => {
                    ...
                    if (newMessageData.user_id === profile.id) {
                        return; // Ignore self-sent messages handled optimistically
                    }
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setNewMessage(content); // Restore user's input
        } finally {
            setIsSending(false);
        }
    };
