...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
    ...
    return (
        ...
        >
            <div 
                className="bg-background rounded-lg shadow-xl w-full max-w-sm animate-scale-in"
            ...
            >
                <div className="p-6">
                    <div className="sm:flex sm:items-start">
                        ...
                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 className="text-lg leading-6 font-bold text-text-heading" id="modal-title">
                                {title}
                            </h3>
                            <div className="mt-2">
                ...
                <div className="bg-slate-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse rounded-b-lg">
                    <button
                        ...
                        onClick={onConfirm}
                        disabled={isLoading}
                        className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white sm:ml-3 sm:w-auto sm:text-sm disabled:opacity-50 ${confirmButtonClass}`}
                    >
